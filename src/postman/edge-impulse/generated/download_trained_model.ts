...
export async function download_trained_model(params: any, apiKey: string) {
  const pathParams: string[] = ["projectId","learnId","modelDownloadId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/learn-data/:learnId/model/:modelDownloadId`;
