 ...
 */
export async function get_user_password_state(params: any, apiKey: string) {
  const pathParams: string[] = ["usernameOrEmail"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api-user-need-to-set-password/:usernameOrEmail`;
