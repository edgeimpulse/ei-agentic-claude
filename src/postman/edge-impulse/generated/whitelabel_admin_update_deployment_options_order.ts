 ...
 */
export async function whitelabel_admin_update_deployment_options_order(params: any, apiKey: string) {
  const pathParams: string[] = ["organizationId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/whitelabel/deploymentOptionsOrder`;
