 ...
 */
export async function update_organization_data_campaign(params: any, apiKey: string) {
<<<<<<< HEAD
...
>>>>>>> origin/main
  ...
  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/campaigns/:campaignId`;
