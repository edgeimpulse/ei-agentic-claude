/**
 * Method: POST
 * URL: https://studio.edgeimpulse.com/v1/api/:projectId/raw-data/batch/add-metadata
 */
export async function batch_add_metadata(params: any, apiKey: string) {
  ...
  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/raw-data/batch/add-metadata`;
