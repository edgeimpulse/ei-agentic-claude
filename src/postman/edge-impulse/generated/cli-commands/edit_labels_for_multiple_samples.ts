...
import { edit_labels_for_multiple_samples } from '../edit_labels_for_multiple_samples.ts';

export function addEdit_labels_for_multiple_samplesCommand(program: Command) {
