 ...
 */
export async function delete_organization_transfer_learning_block(params: any, apiKey: string) {
  const pathParams: string[] = ["organizationId","transferLearningId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/transfer-learning/:transferLearningId`;
