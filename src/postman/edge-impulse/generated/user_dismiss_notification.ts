/**
 * Method: POST
 * URL: https://studio.edgeimpulse.com/v1/api/user/dismiss-notification
 */
export async function user_dismiss_notification(params: any, apiKey: string) {
  const pathParams: string[] = [];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/user/dismiss-notification`;
