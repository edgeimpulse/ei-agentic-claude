 ...
 * Method: GET
 * URL: https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/jobs
 */
export async function list_active_jobs(params: any, apiKey: string) {
  ...
  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/jobs`;
