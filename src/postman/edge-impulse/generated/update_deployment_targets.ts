 ...
 */
export async function update_deployment_targets(params: any, apiKey: string) {
  const pathParams: string[] = ["whitelabelIdentifier"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/whitelabel/:whitelabelIdentifier/deploymentTargets`;
