...
export async function trained_features_for_sample(params: any, apiKey: string) {
  const pathParams: string[] = ["projectId","learnId","sampleId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/training/anomaly/:learnId/features/get-graph/classification/:sampleId`;
