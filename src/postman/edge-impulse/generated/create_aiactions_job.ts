/**
 * Method: POST
 * URL: https://studio.edgeimpulse.com/v1/api/:projectId/jobs/ai-actions/:actionId
 */
export async function create_aiactions_job(params: any, apiKey: string) {
  const pathParams: string[] = ["projectId","actionId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/jobs/ai-actions/:actionId`;
