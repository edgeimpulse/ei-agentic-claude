/**
 * Method: GET
 * URL: https://studio.edgeimpulse.com/v1/api/:projectId/public-info
 */
export async function get_project_info_summary(params: any, apiKey: string) {
  const pathParams: string[] = [];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/public-info`;
