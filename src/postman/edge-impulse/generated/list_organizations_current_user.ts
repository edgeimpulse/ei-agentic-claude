/**
 * Method: GET
 * URL: https://studio.edgeimpulse.com/v1/api/user/organizations
 */
export async function list_organizations_current_user(params: any, apiKey: string) {
  const pathParams: string[] = [];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/user/organizations`;
