...
export async function delete_create_project_file(params: any, apiKey: string) {
  const pathParams: string[] = ["organizationId","createProjectId","createProjectFileId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/create-project/:createProjectId/files/:createProjectFileId`;
