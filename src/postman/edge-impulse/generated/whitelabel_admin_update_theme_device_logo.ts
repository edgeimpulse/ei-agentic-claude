/**
 * Method: POST
 * URL: https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/whitelabel/theme/deviceLogo
 */
export async function whitelabel_admin_update_theme_device_logo(params: any, apiKey: string) {
  const pathParams: string[] = ["organizationId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/whitelabel/theme/deviceLogo`;
