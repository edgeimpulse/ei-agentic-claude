 ...
 * Method: GET
 * URL: https://studio.edgeimpulse.com/v1/api/:projectId/optimize/dsp-parameters
 */
export async function retrieves_dsp_block_parameters(params: any, apiKey: string) {
  const pathParams: string[] = ["projectId"];
  const queryParams: string[] = ["organizationId","organizationDspId"];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/optimize/dsp-parameters`;
