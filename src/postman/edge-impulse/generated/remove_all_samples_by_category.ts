 ...
 */
export async function remove_all_samples_by_category(params: any, apiKey: string) {
  const pathParams: string[] = ["projectId","category"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/raw-data/delete-all/:category`;
