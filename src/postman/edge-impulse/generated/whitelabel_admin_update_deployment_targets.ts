 ...
 */
export async function whitelabel_admin_update_deployment_targets(params: any, apiKey: string) {
<<<<<<< HEAD
...
>>>>>>> origin/main
  ...
  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/whitelabel/deploymentTargets`;
