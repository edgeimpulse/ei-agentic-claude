 ...
 */
export async function get_impulse_blocks_openapi_7b66e3bd(params: any, apiKey: string) {
  const pathParams: string[] = ["projectId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/impulse/blocks`;
