/**
 * Method: POST
 * URL: https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/dataset/:dataset/files/delete
 */
export async function delete_dataset_file(params: any, apiKey: string) {
  const pathParams: string[] = ["organizationId","dataset"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/dataset/:dataset/files/delete`;
