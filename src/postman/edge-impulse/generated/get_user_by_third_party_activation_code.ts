 ...
 */
export async function get_user_by_third_party_activation_code(params: any, apiKey: string) {
  // TODO: Implement parameter mapping
  const res = await fetch(`https://studio.edgeimpulse.com/api/user/by-third-party-activation-code`, {
    method: 'POST',
    headers: {
      'x-api-key': apiKey,
