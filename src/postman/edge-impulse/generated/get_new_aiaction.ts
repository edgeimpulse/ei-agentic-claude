/**
 * Method: GET
 * URL: https://studio.edgeimpulse.com/v1/api/:projectId/ai-actions/new
 */
export async function get_new_aiaction(params: any, apiKey: string) {
  const pathParams: string[] = ["projectId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/ai-actions/new`;
