 ...
 */
export async function set_bounding_boxes(params: any, apiKey: string) {
  const pathParams: string[] = ["projectId","sampleId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/raw-data/:sampleId/bounding-boxes`;
