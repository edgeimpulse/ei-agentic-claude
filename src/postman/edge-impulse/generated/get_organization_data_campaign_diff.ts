/**
 * Method: POST
 * URL: https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/campaigns/:campaignId/diff
 */
export async function get_organization_data_campaign_diff(params: any, apiKey: string) {
  const pathParams: string[] = ["organizationId","campaignId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/campaigns/:campaignId/diff`;
