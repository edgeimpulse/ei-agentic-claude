/**
 * Method: POST
 * URL: https://studio.edgeimpulse.com/v1/api/user/mfa/totp/clear
 */
export async function user_delete_totp_mfa_key(params: any, apiKey: string) {
  const pathParams: string[] = [];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/user/mfa/totp/clear`;
