/**
 * Method: POST
 * URL: https://studio.edgeimpulse.com/v1/api/:projectId/impulse/:impulseId/clone/complete
 */
export async function clone_impulse_complete(params: any, apiKey: string) {
  const pathParams: string[] = ["projectId","impulseId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/impulse/:impulseId/clone/complete`;
