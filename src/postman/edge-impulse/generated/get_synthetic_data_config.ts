/**
 * Method: GET
 * URL: https://studio.edgeimpulse.com/v1/api/:projectId/synthetic-data
 */
export async function get_synthetic_data_config(params: any, apiKey: string) {
<<<<<<< HEAD
...
>>>>>>> origin/main
  ...
  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/synthetic-data`;
