/**
 * Method: GET
 * URL: https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/portals
 */
export async function list_upload_portals(params: any, apiKey: string) {
  const pathParams: string[] = ["organizationId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/portals`;
