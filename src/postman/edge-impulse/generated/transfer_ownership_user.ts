 ...
 */
export async function transfer_ownership_user(params: any, apiKey: string) {
  const pathParams: string[] = ["projectId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/collaborators/transfer-ownership`;
