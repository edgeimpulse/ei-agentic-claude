 ...
 */
export async function get_job_status(params: any, apiKey: string) {
  const pathParams: string[] = ["organizationId","jobId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/jobs/:jobId/status`;
