 ...
 */
export async function whitelabel_admin_update_theme_logo(params: any, apiKey: string) {
<<<<<<< HEAD
...
>>>>>>> origin/main
  ...
  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/whitelabel/theme/logo`;
