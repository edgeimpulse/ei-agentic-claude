/**
 * Method: GET
 * URL: https://studio.edgeimpulse.com/v1/api/:projectId/ai-actions/:actionId/clear-proposed-changes
 */
export async function clear_aiactions_proposed_changes(params: any, apiKey: string) {
  const pathParams: string[] = [];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/ai-actions/:actionId/clear-proposed-changes`;
