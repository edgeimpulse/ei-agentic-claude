 ...
 */
export async function download_dataset_file(params: any, apiKey: string) {
  const pathParams: string[] = ["organizationId","dataset"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/dataset/:dataset/files/download`;
