 ...
 */
export async function change_dataset(params: any, apiKey: string) {
  const pathParams: string[] = ["organizationId"];
  const queryParams: string[] = ["dataset","dataIds","filter"];

  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/data/change-dataset`;
