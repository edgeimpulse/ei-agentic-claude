/**
 * Method: POST
 * URL: https://studio.edgeimpulse.com/v1/api/user/accept-eula
 */
export async function accept_eula(params: any, apiKey: string) {
  const pathParams: string[] = [];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/user/accept-eula`;
