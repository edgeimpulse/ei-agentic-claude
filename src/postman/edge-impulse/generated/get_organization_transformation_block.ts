 ...
 */
export async function get_organization_transformation_block(params: any, apiKey: string) {
<<<<<<< HEAD
...
>>>>>>> origin/main
  ...
  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/transformation/:transformationId`;
