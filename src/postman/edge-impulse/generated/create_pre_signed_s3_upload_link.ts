 ...
 */
export async function create_pre_signed_s3_upload_link(params: any, apiKey: string) {
  const pathParams: string[] = ["portalId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/portals/:portalId/upload-link`;
