 ...
 * Method: POST
 * URL: https://studio.edgeimpulse.com/v1/api/:projectId/raw-data/:sampleId/enable
 */
export async function enable_sample(params: any, apiKey: string) {
  const pathParams: string[] = ["projectId","sampleId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/raw-data/:sampleId/enable`;
