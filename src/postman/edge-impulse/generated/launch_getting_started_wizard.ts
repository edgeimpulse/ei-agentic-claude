 ...
 */
export async function launch_getting_started_wizard(params: any, apiKey: string) {
  const pathParams: string[] = ["projectId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/launch-getting-started`;
