/**
 * Method: POST
 * URL: https://studio.edgeimpulse.com/v1/api/:projectId/compute-time-limit
 */
export async function set_compute_time_limit(params: any, apiKey: string) {
  const pathParams: string[] = ["projectId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/compute-time-limit`;
