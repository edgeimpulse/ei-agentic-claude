/**
 * Method: GET
 * URL: https://studio.edgeimpulse.com/v1/api/:projectId/csv-wizard/download-config
 */
export async function download_csv_wizard_config(params: any, apiKey: string) {
  const pathParams: string[] = [];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/csv-wizard/download-config`;
