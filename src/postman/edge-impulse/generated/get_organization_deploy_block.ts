 ...
 */
export async function get_organization_deploy_block(params: any, apiKey: string) {
  const pathParams: string[] = ["organizationId","deployId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/deploy/:deployId`;
