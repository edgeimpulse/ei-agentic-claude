 ...
 */
export async function save_parameters_for_pretrained_model(params: any, apiKey: string) {
  // TODO: Implement parameter mapping
  const res = await fetch(`https://studio.edgeimpulse.com/api/:projectId/pretrained-model/save`, {
    method: 'POST',
    headers: {
      'x-api-key': apiKey,
