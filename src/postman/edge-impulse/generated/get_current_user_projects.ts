/**
 * Method: GET
 * URL: https://studio.edgeimpulse.com/v1/api/user/projects
 */
export async function get_current_user_projects(params: any, apiKey: string) {
  const pathParams: string[] = [];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/user/projects`;
