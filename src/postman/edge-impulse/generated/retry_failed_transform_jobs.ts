 ...
 */
export async function retry_failed_transform_jobs(params: any, apiKey: string) {
  const pathParams: string[] = ["organizationId","createProjectId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/create-project/:createProjectId/transform/retry`;
