 ...
 */
export async function download_historic_deployment(params: any, apiKey: string) {
<<<<<<< HEAD
...
>>>>>>> origin/main
  ...
  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/deployment/history/:deploymentVersion/download`;
