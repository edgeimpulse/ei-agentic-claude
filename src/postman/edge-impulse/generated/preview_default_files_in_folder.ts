 ...
 */
export async function preview_default_files_in_folder(params: any, apiKey: string) {
<<<<<<< HEAD
...
>>>>>>> origin/main
  ...
  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/dataset/:dataset/files/preview`;
