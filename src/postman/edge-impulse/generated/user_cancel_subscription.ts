/**
 * Method: POST
 * URL: https://studio.edgeimpulse.com/v1/api/user/subscription/cancel
 */
export async function user_cancel_subscription(params: any, apiKey: string) {
  const pathParams: string[] = [];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/user/subscription/cancel`;
