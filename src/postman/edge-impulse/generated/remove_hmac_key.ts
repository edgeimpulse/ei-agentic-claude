 ...
 */
export async function remove_hmac_key(params: any, apiKey: string) {
  const pathParams: string[] = ["projectId","hmacId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/hmackeys/:hmacId`;
