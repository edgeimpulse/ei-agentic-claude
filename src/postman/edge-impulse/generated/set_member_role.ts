 ...
 */
export async function set_member_role(params: any, apiKey: string) {
  const pathParams: string[] = ["organizationId","memberId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/members/:memberId/role`;
