 ...
 */
export async function list_deployment_targets_for_project(params: any, apiKey: string) {
<<<<<<< HEAD
...
>>>>>>> origin/main
  ...
  let url = `https://studio.edgeimpulse.com/v1/api/:projectId/deployment/targets`;
