 ...
 */
export async function verify_upload_portal_information(params: any, apiKey: string) {
  const pathParams: string[] = ["organizationId","portalId"];
  const queryParams: string[] = [];

  let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/portals/:portalId/verify`;
