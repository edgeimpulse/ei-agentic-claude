 ...
 * Method: GET
 * URL: https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/jobs/:jobId/stdout
 */
export async function get_logs(params, apiKey) {
    const pathParams = ["organizationId", "jobId"];
    const queryParams = ["limit", "logLevel"];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/jobs/:jobId/stdout`;
