 ...
 */
export async function sample_of_trained_features(params, apiKey) {
    const pathParams = ["projectId", "dspId", "category"];
    const queryParams = ["featureAx1", "featureAx2", "featureAx3"];
    let url = `https://studio.edgeimpulse.com/v1/api/:projectId/dsp/:dspId/features/get-graph/:category`;
