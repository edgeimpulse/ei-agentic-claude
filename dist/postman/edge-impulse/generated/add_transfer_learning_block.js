 ...
 */
export async function add_transfer_learning_block(params, apiKey) {
    const pathParams = ["organizationId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/transfer-learning`;
