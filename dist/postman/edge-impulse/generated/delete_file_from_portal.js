 ...
 */
export async function delete_file_from_portal(params, apiKey) {
    const pathParams = ["portalId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/portals/:portalId/files/delete`;
