 ...
 */
export async function get_pipeline(params, apiKey) {
    const pathParams = ["organizationId", "pipelineId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/pipelines/:pipelineId`;
