 ...
 */
export async function delete_dsp_block(params, apiKey) {
    const pathParams = ["organizationId", "dspId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/dsp/:dspId`;
