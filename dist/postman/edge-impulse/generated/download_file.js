 ...
 */
export async function download_file(params, apiKey) {
    const pathParams = ["organizationId", "dataId"];
    const queryParams = ["fileName"];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/data/:dataId/files/download`;
