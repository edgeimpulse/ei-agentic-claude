/**
 * Method: POST
 * URL: https://studio.edgeimpulse.com/v1/api/users/:userId/change-password
 */
export async function change_password(params, apiKey) {
    const pathParams = ["userId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/users/:userId/change-password`;
