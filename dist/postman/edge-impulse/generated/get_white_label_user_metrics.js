 ...
 */
export async function get_white_label_user_metrics(params, apiKey) {
    const pathParams = ["organizationId", "userId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/whitelabel/users/:userId/metrics`;
