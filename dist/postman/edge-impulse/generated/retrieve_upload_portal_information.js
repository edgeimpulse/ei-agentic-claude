 ...
 */
export async function retrieve_upload_portal_information(params, apiKey) {
    const pathParams = ["organizationId", "portalId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/portals/:portalId`;
