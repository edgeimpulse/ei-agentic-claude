 ...
 */
export async function get_white_label_domain(params, apiKey) {
    const pathParams = ["whitelabelIdentifier"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/whitelabel/:whitelabelIdentifier/domain`;
