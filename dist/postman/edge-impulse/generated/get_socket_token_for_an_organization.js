 ...
 */
export async function get_socket_token_for_an_organization(params, apiKey) {
    const pathParams = ["organizationId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/socket-token`;
