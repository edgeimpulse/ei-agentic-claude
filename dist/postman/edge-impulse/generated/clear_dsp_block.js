 ...
 */
export async function clear_dsp_block(params, apiKey) {
    const pathParams = ["projectId", "dspId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/:projectId/dsp/:dspId/clear`;
