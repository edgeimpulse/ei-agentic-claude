 ...
 */
export async function list_files(params, apiKey) {
    const pathParams = ["organizationId"];
    const queryParams = ["dataset", "filter", "limit", "offset"];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/data/files`;
