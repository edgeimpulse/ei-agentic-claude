 ...
 */
export async function get_transformation_job_status(params, apiKey) {
    const pathParams = ["organizationId", "createProjectId"];
    const queryParams = ["transformLimit", "transformOffset", "selection"];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/create-project/:createProjectId`;
