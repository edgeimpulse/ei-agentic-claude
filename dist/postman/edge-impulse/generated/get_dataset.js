 ...
 */
export async function get_dataset(params, apiKey) {
    const pathParams = ["organizationId", "dataset"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/dataset/:dataset`;
