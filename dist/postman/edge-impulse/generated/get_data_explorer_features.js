 ...
 */
export async function get_data_explorer_features(params, apiKey) {
    const pathParams = ["projectId", "learnId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/:projectId/training/keras/:learnId/data-explorer/features`;
