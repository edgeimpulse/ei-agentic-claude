 ...
 */
export async function resend_invitation(params, apiKey) {
    const pathParams = ["organizationId", "memberId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/members/:memberId/resend-invite`;
