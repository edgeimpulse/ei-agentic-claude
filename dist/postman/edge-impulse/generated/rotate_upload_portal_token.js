 ...
 */
export async function rotate_upload_portal_token(params, apiKey) {
    const pathParams = ["organizationId", "portalId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/portals/:portalId/rotate-token`;
