 ...
 */
export async function add_a_collaborator_to_a_project_within_an_organisation(params, apiKey) {
    const pathParams = ["organizationId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/add-project-collaborator`;
