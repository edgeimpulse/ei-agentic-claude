 ...
 */
export async function update_white_label_project(params, apiKey) {
    const pathParams = ["organizationId", "projectId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/whitelabel/projects/:projectId`;
