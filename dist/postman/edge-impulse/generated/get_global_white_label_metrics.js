 ...
 */
export async function get_global_white_label_metrics(params, apiKey) {
    const pathParams = ["organizationId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/organizations/:organizationId/whitelabel/metrics`;
