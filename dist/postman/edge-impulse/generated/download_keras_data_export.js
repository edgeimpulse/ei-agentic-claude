 ...
 */
export async function download_keras_data_export(params, apiKey) {
    const pathParams = ["projectId", "learnId"];
    const queryParams = [];
    let url = `https://studio.edgeimpulse.com/v1/api/:projectId/training/keras/:learnId/download-data`;
